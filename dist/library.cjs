...
class BroadcastChannelTransport extends AbstractTransport {
    constructor() {
        super(...arguments);
        this.transportType = exports.TransportType.broadcastChannel;
    }
    static isSupported() {
...
class SessionStorageTransport extends AbstractTransport {
    constructor() {
        super(...arguments);
        this.transportType = exports.TransportType.sessionStorage;
...
class SharedWorkerTransport extends AbstractTransport {
    constructor() {
        super(...arguments);
        this.beforeunloadHandler = () => this.disconnect();
        this.transportType = exports.TransportType.sharedWorker;
    }
    static isSupported() {
...
function transportFabric(transportType) {
    switch (transportType) {
        case exports.TransportType.sessionStorage:
