(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var BroadcastChannelTransport=function(t){function n(){var n=null!==t&&t.apply(this,arguments)||this;return n.transportType=exports.TransportType.broadcastChannel,n}return __extends(n,t),n.isSupported=function(){return !!self.BroadcastChannel},n.prototype.connect=function(t){return __awaiter(this,void 0,void 0,(function(){var n,r,o=this;return __generator(this,(function(e){try{return this.throwIfNotSupported(),(r=new BroadcastChannel((null==t?void 0:t.storageKey)||DefaultStorageKeyPrefix)).onmessage=function(t){return o.onMessage(t.data)},this.channel=r,n=this.getConnectionState(),this.onConnected(n),[2,n]}catch(t){(n=this.getConnectionState()).error=t,this.onConnectionError(n);}throw n}))}))},n.prototype.disconnect=function(){var t;return __awaiter(this,void 0,void 0,(function(){var n;return __generator(this,(function(r){return null===(t=this.channel)||void 0===t||t.close(),this.channel=void 0,n=this.getConnectionState(),this.onDisconnected(n),[2,n]}))}))},n.prototype.postMessage=function(t){var n;return __awaiter(this,void 0,void 0,(function(){return __generator(this,(function(r){return null===(n=this.channel)||void 0===n||n.postMessage(t),[2]}))}))},n.prototype.getConnectionState=function(){return {type:exports.TransportType.broadcastChannel,connected:!!this.channel}},n.prototype.throwIfNotSupported=function(){if(!n.isSupported()){var t=this.getConnectionState();throw t.error=new Error("Broadcast Channel is not supported"),t}},n}(AbstractTransport);
    ...
    function transportFabric(r){switch(r){case exports.TransportType.sessionStorage:return new SessionStorageTransport;case exports.TransportType.sharedWorker:return new SharedWorkerTransport;case exports.TransportType.broadcastChannel:return new BroadcastChannelTransport;default:throw new Error("Unknown transport type: "+r)}}
