...
#### constructor(options?: [IpcOptions][ipcoptions])

Creates an instance of [BrowserTabIPC][browsertabipc] class.

- **options?: [IpcOptions][ipcoptions]** Optional parameter `options` provides options to create a new instance.
...
- **options?: [ConnectionOptions][connectionoptions]** Optional parameter `options` provides connection options to IPC instance.
